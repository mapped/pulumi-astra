...
func NewKeyspace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("index:astra/keyspace:Keyspace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeyspace(ctx *pulumi.Context,
	...
	var resource Keyspace
	err := ctx.ReadResource("index:astra/keyspace:Keyspace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
