...
{
    [AstraResourceType("index:astra/role:Role")]
    public partial class Role : Pulumi.CustomResource
    {
        ...
        /// <summary>
        /// Resources for which role is applicable
        /// </summary>
        [Output("resources")]
        ...
        public Role(string name, RoleArgs args, CustomResourceOptions? options = null)
            : base("index:astra/role:Role", name, args ?? new RoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Role(string name, Input<string> id, RoleState? state = null, CustomResourceOptions? options = null)
            : base("index:astra/role:Role", name, state, MakeResourceOptions(options, id))
        {
        }
