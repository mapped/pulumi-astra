...
{
    [AstraResourceType("index:astra/accessList:AccessList")]
    public partial class AccessList : Pulumi.CustomResource
    {
        ...
        public AccessList(string name, AccessListArgs args, CustomResourceOptions? options = null)
            : base("index:astra/accessList:AccessList", name, args ?? new AccessListArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessList(string name, Input<string> id, AccessListState? state = null, CustomResourceOptions? options = null)
            : base("index:astra/accessList:AccessList", name, state, MakeResourceOptions(options, id))
        {
        }
