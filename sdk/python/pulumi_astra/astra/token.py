...
class TokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] roles: List of Role IDs to be assigned to the generated token
        """
...
class _TokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] client_id: Client id, use as username in cql to connect
        :param pulumi.Input[Sequence[pulumi.Input[str]]] roles: List of Role IDs to be assigned to the generated token
        :param pulumi.Input[str] secret: Secret, use as password in cql to connect
        :param pulumi.Input[str] token: Token, use as auth bearer for API calls or as password in combination with the word `token` in cql
        """
