...
class DatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cloud_provider: The cloud provider to launch the database.
        :param pulumi.Input[str] keyspace: keyspace
        :param pulumi.Input[Sequence[pulumi.Input[str]]] regions: Cloud region to launch the database.
